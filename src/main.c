...
#define INS_GET_TXN_HASH    (0x01u << 3u)
#define INS_GET_PRIVATE_KEY (0x01u << 4u)
...
handler_fn_t handleGetPrivateKey;
...
static handler_fn_t* lookupHandler(uint8_t ins) {
	...
	case INS_GET_PRIVATE_KEY: return handleGetPrivateKey;
	default:                  return NULL;
	}
}
